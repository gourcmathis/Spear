...
//gere le cas où le joueur a gagné
public class Victoire extends Parent {
    ...
    public Victoire() {
        //Box contennat la fenetre victoire
        root=new VBox(30);
        //Menu post victoire
        ...
        ft.setToValue(0);
        ft.play();
        //Quand on gagne la victoire s'affiche puis la fenetre se ferme et un menu principale s'ouvre pour pouvoir rejouer
